...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-mailgun-live open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-mailgun-live project authors
